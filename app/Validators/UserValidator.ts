...
import {
  getUserAvatarOptions, getUserCityRules, getUserCompanyNameRules,
  getUserEmailRules, getUserFirstNameRules, getUserLastNameRules,
  getUserPhoneRules, getUserTaxIdentificationNumberRules
